...
**Goal:** The audited post-POC release-hardening epic is complete; choose the next product increment from new user feedback rather than extending the closed scope pre-emptively.
